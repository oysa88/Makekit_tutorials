...
Fjernkontrollen vi skal programmere skal sende forskjellige radiosignaler til Hoverbit. Nå skal vi sette opp dette.
...
- ``||input: Når knapp A trykkes||``: Endre ``||variabel: Throttle||`` med -10.

- ``||input: Når knapp B trykkes||``: Endre ``||variabel: Throttle||`` med +10.
